...
void Application::setScene(int num)
{
	sceneNum = num;
}
...
void Application::Init()
{
	...
	m_width = 800;
	m_height = 600;
	m_window = glfwCreateWindow(m_width, m_height, "Test Window",
		NULL, NULL);
...
void Application::Run()
{
	...
	Scene* startingscene = new SceneMain();
	Scene* minigame1 = new mini_game_1();
	Scene* minigame2 = new mini_game_2();
	Scene* minigame3 = new mini_game_3();
	Scene* minigame4 = new SceneObstacle();
	Scene* minigame5 = new mini_game_5();
	Scene* game_over = new Game_over();
